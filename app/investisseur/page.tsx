...
const formatCurrency = (amount: number): string => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <Head>
        <title>AgriTech Sénégal - Plateforme de Microfinancement</title>
        <meta name="description" content="Connecter agriculteurs, investisseurs et marchés au Sénégal" />
      ...
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 w-64 bg-green-800 text-white transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:block`}>
        ...
        <nav className="p-4">
          <ul className="space-y-2">
            <li>
              <Link href="/investisseur" className="flex items-center p-2 rounded-md bg-green-700 hover:bg-green-600">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <header className="bg-white shadow">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-semibold text-gray-800">Investisseur</h2>
            </div>
        ...
        <main className="p-6">
          ...
          <section className="mb-8">
            <h3 className="text-lg font-semibold text-gray-700 mb-4">Résumé du portefeuille</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="text-sm font-medium text-gray-500">Rendement attendu</h4>
                <p className="text-2xl font-bold text-green-600">{formatCurrency(portfolioSummary.expectedReturn)}</p>
                <p className="text-sm text-gray-500">ROI moyen de {portfolioSummary.averageROI}%</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="text-sm font-medium text-gray-500">Impact social</h4>
                <p className="text-2xl font-bold text-gray-800">{portfolioSummary.impact.farmers} agriculteurs</p>
                <p className="text-sm text-gray-500">{portfolioSummary.impact.jobs} emplois créés</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="text-sm font-medium text-gray-500">Impact environnemental</h4>
                <p className="text-2xl font-bold text-gray-800">{portfolioSummary.impact.hectares} hectares</p>
          ...
          <section className="mb-8">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-700">Projets en vedette</h3>
              <Link href="/dashboard/investor/projects" className="text-green-600 hover:underline text-sm font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredProjects.map(project => (
                <div key={project.id} className="bg-white rounded-lg shadow overflow-hidden">
                  ...
                  <div className="p-4">
                    <h4 className="font-semibold text-black/75 mb-1">{project.title}</h4>
                    <p className="text-gray-600 text-sm mb-2">Par {project.farmer} • {project.location}</p>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="flex justify-between text-xs text-gray-500 mt-1">
                        <span>Objectif: {formatCurrency(project.fundingGoal)}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-5 rounded-lg shadow">
                <h3 className="text-lg font-semibold text-gray-700 mb-4">Catégories de projets</h3>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-5 rounded-lg shadow">
                <h3 className="text-lg font-semibold text-gray-700 mb-4">Opportunités recommandées</h3>
                <div className="space-y-4">
                  <div className="p-4 border border-green-100 rounded-lg bg-green-50">
                    <div className="flex justify-between">
                      <div>
                        <h4 className="font-medium text-black/75">Investissez dans l&rsquo;agriculture biologique</h4>
                        <p className="text-sm text-gray-600 mt-1">
                          Les projets d&rsquo;agriculture biologique offrent un rendement moyen de 18% avec un impact environnemental positif.
                        </p>
                      </div>
                  ...
                  <div className="p-4 border border-blue-100 rounded-lg bg-blue-50">
                    <div className="flex justify-between">
                      <div>
                        <h4 className="font-medium text-black/75">Diversifiez votre portefeuille</h4>
                        <p className="text-sm text-gray-600 mt-1">
                          Réduisez les risques en investissant dans différents types de cultures et régions.
                        </p>
                      </div>
